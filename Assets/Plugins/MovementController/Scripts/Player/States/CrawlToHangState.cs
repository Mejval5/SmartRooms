...
namespace Spelunky {
    ...
    public class CrawlToHangState : State {
        ...
        public override bool CanEnterState() {
            ...
            Vector3 offset = new Vector3(-6 / 16f * player.Visuals.facingDirection, 1 / 16f, 0);
            RaycastHit2D hit = Physics2D.Raycast(transform.position + offset, Vector2.down, 2 / 16f, player.edgeGrabLayerMask);
