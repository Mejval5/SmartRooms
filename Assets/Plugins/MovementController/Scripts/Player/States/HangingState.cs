...
namespace Spelunky {
    ...
    public class HangingState : State {
        ...
        public override void EnterState() {
            Vector2 hangPosition = new Vector2(transform.position.x, colliderToHangFrom.transform.position.y + _hangOffsetY + colliderToHangFrom.offset.y);
